 ...
 *
 */
public class RepairDistributionLog {
	private String log_id;
	private String distribution_id;  //对应工单的id
	private String operator_id;   //操作人id
	private String before_status;  //操作之前的工单状态
	...
	public String toString() {
		return "RepairDistributionLog [log_id=" + log_id + ", distribution_id=" + distribution_id + ", operator_id="
				+ operator_id + ", before_status=" + before_status + ", after_status=" + after_status
				+ ", operator_time=" + operator_time + ", remark=" + remark + ", sys_record_status=" + sys_record_status
